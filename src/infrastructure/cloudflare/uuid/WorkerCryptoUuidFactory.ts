...
export class WorkerCryptoUuidFactory extends UuidFactoryImpl implements UuidFactory {
	private static _instance: WorkerCryptoUuidFactory;
	static instance(): WorkerCryptoUuidFactory {
		return (WorkerCryptoUuidFactory._instance ??= new WorkerCryptoUuidFactory());
	}
