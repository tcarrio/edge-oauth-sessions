...
const EnvRouterConfigSchema = z.object({
	...
	ROUTER_COOKIE_KEY: z
		.string()
		.optional()
		.default(RouterConfigDefaults.cookieKey),
	ROUTER_CALLBACK_PATH: z
		.string()
		.optional()
		.default(RouterConfigDefaults.callbackPath),
	ROUTER_LOGIN_PATH: z
		.string()
		.optional()
		.default(RouterConfigDefaults.loginPath),
	ROUTER_LOGOUT_PATH: z
		.string()
		.optional()
		.default(RouterConfigDefaults.logoutPath),
});
